  ...
  <form onsubmit={save}>
    <div class="card">
      ...
      <div class="form-grid">
        ...
        <div class="field"><label for="lg">Logo (PNG/SVG, max. 300 KB)</label><input id="lg" type="file" accept="image/*" onchange={logo} />
    ...
    <div class="card">
      <h3 style="margin-top:0">BMD-Schnittstelle</h3>
      <div class="form-grid">
      ...
      <label><input type="checkbox" bind:checked={s.bmd_krank_exportieren} />Krankenstände zum Abgleich mit exportieren (302/303/314). Standard: aus, da über ÖGK-Import.</label>
    </div>
    <div class="card">
    ...
    <div class="card">
      <h3 style="margin-top:0">PDF-Bericht</h3>
      <div class="form-grid">
